    ...
    <div class="page-grid">
      <div class="grid-col-form">
        <section class="panel">
          ...
          <form method="POST">
            ...
            <label>Nombre</label>
            <input type="text" name="name" value="<?= htmlspecialchars($item['name']) ?>" required style="margin-bottom:15px;">
      ...
      <div class="grid-col-table">
        <section class="panel">
           ...
           <table>
              <thead>
                  <tr><th>ID</th><th>Nombre</th><th>Rol</th><th>Facción</th><th>Acciones</th></tr>
              </thead>
              <tbody>
