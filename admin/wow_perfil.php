      ...
      <div class="grid-col-form">
        <section class="panel">
          ...
          <form method="POST">
            ...
            <input type="text" value="<?= htmlspecialchars($user['username']) ?>" disabled style="margin-bottom:15px; opacity:0.7;">
            
            <label>Rol</label>
            <input type="text" value="<?= ucfirst($user['role']) ?>" disabled style="margin-bottom:15px; opacity:0.7; color:#ffd100;">
            
            <label>Email</label>
            <input type="email" name="email" value="<?= htmlspecialchars($user['email']) ?>" required style="margin-bottom:15px;">
