...
if (isset($_GET['edit'])) {
    ...
    if($found) { $item = $found; $editMode = true; }
}
      ...
      <div class="grid-col-form">
        <section class="panel">
          ...
          <form method="POST">
            ...
            <label>Usuario</label>
            <input type="text" name="username" value="<?= htmlspecialchars($item['username']) ?>" required style="margin-bottom:15px;">
            
            <label>Email</label>
            <input type="email" name="email" value="<?= htmlspecialchars($item['email']) ?>" required style="margin-bottom:15px;">
      ...
      <div class="grid-col-table">
        <section class="panel">
           ...
           <div class="pagination">
              ...
              <?php if($pagina < $totalPaginas): ?><a href="?page=<?= $pagina+1 ?>" class="btn-wow secondary">Sig</a><?php endif; ?>
           </div>
        </section>
      </div>
    </div>
